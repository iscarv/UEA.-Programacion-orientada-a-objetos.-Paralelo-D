...
def mostrar_menu():
    ...
    unidades = {
        '1': 'UNIDAD 1/Semana 2/Abstraccion/abstraccion.py',
        '2': 'UNIDAD 1/Semana 2/Encapsulacion/encapsulacion.py',
        '3': 'UNIDAD 1/Semana 2/Herencia/herencia.py',
        '4': 'UNIDAD 1/Semana 2/Polimorfismo/polimorfismo.py',
        '5': 'UNIDAD 1/Semana 3/Promedio semanal del clima. POO.py',
        '6': 'UNIDAD 1/Semana 3/Promedio semanal del clima. Programacion Tradicional.py',
        '7': 'UNIDAD 1/Semana 4/EjemplosMundoReal_POO/Programa 1. Ejemplos.MundoReal.py',
        '8': 'UNIDAD 1/Semana 4/EjemplosMundoReal_POO/Programa 2. Ejemplos.MundoReal.py',
        '9': 'UNIDAD 2/Semana 5/Tipos de datos_identificadores.py',
        '10': 'UNIDAD 2/Semana 6/Semana 06. Clases, objetos, herencia, encapsulamiento y polimorfismo.py',
        '11': 'UNIDAD 2/Semana 7/Constructores y Destructores.py',
